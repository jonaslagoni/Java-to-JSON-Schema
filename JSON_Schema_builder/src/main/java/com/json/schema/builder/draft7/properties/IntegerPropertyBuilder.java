 ...
 * @author lagoni
 */
public class IntegerPropertyBuilder extends AbstractPropertyBuilder<IntegerPropertyBuilder>{

    public IntegerPropertyBuilder() {
        super();
    }

    public IntegerPropertyBuilder(Schema schema) {
        super(schema);
    }
    ...
    public IntegerPropertyBuilder(ObjectSchemaBuilder ob, Schema schema) {
        super(ob, schema);
    }
